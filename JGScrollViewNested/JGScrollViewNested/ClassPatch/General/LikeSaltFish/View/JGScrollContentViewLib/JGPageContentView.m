...
#import "JGPageContentView.h"

#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] floatValue])
static NSString *collectionCellIdentifier = @"collectionCellIdentifier";

@interface JGPageContentView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation JGPageContentView
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(JGContentViewWillBeginDragging:)]) {
        [self.delegate JGContentViewWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(JGContentViewDidScroll:startIndex:endIndex:progress:)]) {
        [self.delegate JGContentViewDidScroll:self startIndex:startIndex endIndex:endIndex progress:progress];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(JGContenViewDidEndDecelerating:startIndex:endIndex:)]) {
        [self.delegate JGContenViewDidEndDecelerating:self startIndex:startIndex endIndex:endIndex];
    }
}
